            ...
            <div class="p-4 bg-white shadow-sm sm:p-8 sm:rounded-lg">
                <section>
                    ...
                    <div class="mb-4 border-2 card">
                        ...
                        <div class="card-body">
                            @if (count($janji_periksa->periksa->detail_periksa) > 0)
                                <ul class="list-group list-group-flush">
                                    @foreach ($janji_periksa->periksa->detail_periksa as $detailPeriksa)
                                        <li
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <span class="fw-bold fs-5 text-primary">
                                    {{ 'Rp' . number_format($janji_periksa->periksa->biaya, 0, ',', '.') }}
                                </span>
                            </div>
                        </div>
                    </div>
